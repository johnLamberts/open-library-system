...
import { itemTypeColumns } from "@/features/Settings/ItemTypes/ItemTypeColumns";
import ItemTypesForm from "@/features/Settings/ItemTypes/ItemTypeForm";
import { useCategory } from "@/lib/react-query/queries";
    ...
    <>
      <div className="h-full p-[30px]">
              ...
              >
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Set your categories in the library system
                  </p>
                </div>
              </header>
        ...
        <div className="p-6 w-full">
          <DataTable data={category} columns={itemTypeColumns} />
        </div>
      </div>
    </>
  );
